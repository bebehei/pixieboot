...
config(){
	...
	echo "  menu label Ubuntu 14.04 Server rescue"
...
installation(){
	...
	chroot $BASE_SYSTEMS/$DISTRO_NAME env DEBIAN_FRONTEND=noninteractive apt-get install -y vim linux-image-generic
